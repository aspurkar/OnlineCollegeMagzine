...
function myProfile(){
	...
	$('#studentform').attr('action', "/ocm/student/getMyProfile").submit();
}
function studentDashboard(){
	var studentId = document.getElementById("studentId").value;
	$('#studentId').val(studentId);
	$('#studentform').attr('action', "/ocm/getDashboard").submit();
}
function postArticle(){
	var studentId = document.getElementById("studentId").value;
	$('#studentId').val(studentId);
	$('#studentform').attr('action', "/ocm/student/getPostArticle").submit();
}
function findArticles(){
	$('#studentform').attr('action', "/ocm/student/findArticles").submit();
}
</script>
</head>
<body>
<form id="studentform" class="form-horizontal" role="form">
