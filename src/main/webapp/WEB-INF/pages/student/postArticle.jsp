...
function myProfile(){
	...
	$('#studentPostArtform').attr('action', "/ocm/student/getMyProfile").submit();
}
function studentDashboard(){
	var studentId = document.getElementById("studentId").value;
	$('#studentId').val(studentId);
	$('#studentPostArtform').attr('action', "/ocm/getDashboard").submit();
}
function postArticle(){
	var studentId = document.getElementById("studentId").value;
	$('#studentId').val(studentId);
	$('#studentPostArtform').attr('action', "/ocm/student/getPostArticle").submit();
}
function findArticles(){
	$('#studentPostArtform').attr('action', "/ocm/student/findArticles").submit();
}
</script>
</head>
<body>
<form id="studentPostArtform" class="form-horizontal" role="form" action="/ocm/student/savePostArticle">
<div class="wrapper">
    ...
    -->
    	...
    	<div class="sidebar-wrapper">
            <div class="logo">
             ...
             <ul class="nav">
                <li>
                    <a href="#" onclick="studentDashboard();">
        ...
        <div class="content">
            <div class="container-fluid">
                ...
                <div class="col-md-12" >
								<div class="card">
									<div class="header">
										<h4 class="title">Post Article</h4>
									</div>
							...
							<div class="section-body">
								<p class="col-xs-9 col-xs-offset-3"
									...
									<div class="content">
											...
											<button type="submit"
												class="btn btn-info btn-fill pull-right">Save Article</button>
...
<input type="hidden" id="catId" name="catId" value="${article.categoryId }"/>
<input type="hidden" id="studentId" name="studentId" value="${user.userId }"/>
</form>
</body>
