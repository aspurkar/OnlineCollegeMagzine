...
<body>
<form id="moderatorform" class="form-horizontal" role="form" action="/ocm/moderator/savePostArticle">
<div class="wrapper">
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<textarea rows="10" class="form-control" id="articleBody" name="articleBody"
															placeholder="write about your article here.." value="${article.heading }">${article.heading }</textarea>
													</div>
