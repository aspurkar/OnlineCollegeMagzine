...
<body>
	<form id="moderatorform" class="form-horizontal" role="form" action="/ocm/moderator/updteModer">
		<div class="wrapper">
<div class="sidebar" data-color="black" data-image="<c:url value="/external/assets/img/sidebar-5.jpg" />">
    ...
    -->
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>Username</label> <input type="text" id="uname" name="uname" 
															...
															value="${modrProf.uname}">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label for="exampleInputEmail1">Email address</label> <input id="email" name="email" 
															type="email" class="form-control" placeholder="Email" value="${modrProf.email}">
													</div>
												</div>
											</div>
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>First Name</label> <input type="text" id="fname" name="fname" 
															class="form-control" placeholder="Company" value="${modrProf.fname}">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
												...
												<div class="col-md-6">
													<div class="form-group">
														<label>City</label> <input type="text" id="city" name="city"
															class="form-control" placeholder="City" value="${modrProf.city}">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>State</label> <input type="text" id="state" name="state"
															class="form-control" placeholder="State" value="${modrProf.state}">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>Country</label> <input type="text" id="country" name="country"
															class="form-control" placeholder="Country" value="${modrProf.country}">
													</div>
												</div>
												<div class="col-md-6">
													<div class="form-group">
														<label>Postal Code</label> <input type="number" id="pincode" name="pincode"
															class="form-control" placeholder="ZIP Code" value="${modrProf.pincode}">
													</div>
												</div>
											</div>
												...
												<div class="col-md-12">
													<div class="form-group">
														...
														<textarea rows="5" class="form-control" id="aboutme" name="aboutme"
															placeholder="Here can be your description" value="${modrProf.aboutme}">${modrProf.aboutme}</textarea>
													</div>
												</div>
											</div>
		...
		<input type="hidden" id="userId" name="userId" value="${modrProf.userId }" />
