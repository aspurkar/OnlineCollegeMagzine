...
function manageUsers(){
	$('#editArticleform').attr('action', "/ocm/admin/getUsers").submit();
}
function manageArticles(){
	$('#editArticleform').attr('action', "/ocm/article/manageArticles").submit();
}
function myProfile(){
	$('#editArticleform').attr('action', "/ocm/admin/myProfile").submit();
}
</script>
</head>
<body>
<form id="editArticleform" class="form-horizontal" role="form" action="/ocm/article/updateArticle">
<div class="wrapper">
