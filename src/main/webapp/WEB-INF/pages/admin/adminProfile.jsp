...
function adminDashboard(){
	$('#adminProfileForm').attr('action', "/ocm/getDashboard").submit();
}

function manageUsers(){
	$('#adminProfileForm').attr('action', "/ocm/admin/getUsers").submit();
}
function manageArticles(){
	$('#adminProfileForm').attr('action', "/ocm/article/manageArticles").submit();
}
function myProfile(){
	$('#adminProfileForm').attr('action', "/ocm/admin/myProfile").submit();
}
</script>
</head>
<body>
	<form id="adminProfileForm" class="form-horizontal" role="form" action="/ocm/admin/updteUser">
		<div class="wrapper">
