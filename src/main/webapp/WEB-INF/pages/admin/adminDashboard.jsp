...
<head>
	<meta charset="utf-8" />
	<link rel="icon" type="image/png" href="<c:url value="/external/assets/img/favicon.ico" />">
...
function adminDashboard(){
	$('#adminform').attr('action', "/ocm/getDashboard").submit();
}

function manageUsers(){
	$('#adminform').attr('action', "/ocm/admin/getUsers").submit();
}
function viewArticle(artId){
	$('#artId').val(artId);
	$('#adminform').attr('action', "/ocm/article/viewArticle").submit();
}
function manageArticles(){
	$('#adminform').attr('action', "/ocm/article/manageArticles").submit();
}
function myProfile(){
	$('#adminform').attr('action', "/ocm/admin/myProfile").submit();
}
function removeArticle(artId){
	$('#artId').val(artId);
	$('#adminform').attr('action', "/ocm/article/rmvArticle").submit();
}
</script>
</head>
<body>
<form id="adminform" class="form-horizontal" role="form">
<div class="wrapper">
    <div class="sidebar" data-color="black" data-image="<c:url value="/external/assets/img/sidebar-5.jpg" />">
    	...
    	<div class="sidebar-wrapper">
            ...
            <ul class="nav">
                ...
                <li>
                    <a id="mngUsersLink" href="#" onclick="manageUsers();">
                        <i class="pe-7s-news-paper"></i>
                        <p>Manage Users</p>
                    </a>
                </li>
                <li>
                    <a href="#" onclick="manageArticles();">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li>
                        	<a href="#"> Welcome, ${user.fname } &nbsp; ${user.lname }</a>
                        </li>
